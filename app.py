...
def show_prediction():
    ...
    # Save user data and prediction result to CSV file
    with open('user_data.csv', mode='a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([user_data['gender'], user_data['age'], user_data['hypertension'], 
                         user_data['heart_disease'], user_data['ever_married'], user_data['work_type'], 
                         user_data['residence_type'], user_data['glucose_level'], user_data['height'], 
                         user_data['weight'], user_data['smoking_status'], prediction])
...
def show_prediction():
    ...
    with open('user_data.csv', mode='a', newline='') as file:
        ...
        if file.tell() == 0:
            writer.writerow(['Gender', 'Age', 'Hypertension', 'Heart Disease', 'Ever Married', 'Work Type', 'Residence Type', 'Glucose Level', 'Height', 'Weight', 'Smoking Status', 'Prediction'])
...
def show_prediction():
    ...
    # Change the file path to a location where you have write permissions
    file_path = "C:/2nd year/PA PROJECT/user_data.csv"
